      ...
      <div className="py-10 px-4">
        ...
        <div className="mt-10 flex justify-around">
          <div className="flex flex-col items-center">
            ...
            <span className="medium mt-2 text-sm text-gray-700">판매내역</span>
          </div>
          <div className="flex flex-col items-center">
            <div className="flex h-14 w-14 items-center justify-center rounded-full bg-orange-500 text-white">
              <svg
            ...
            <span className="medium mt-2 text-sm text-gray-700">구매내역</span>
          </div>
          <div className="flex flex-col items-center">
            <div className="flex h-14 w-14 items-center justify-center rounded-full bg-orange-500 text-white">
              <svg
            ...
            <span className="medium mt-2 text-sm text-gray-700">관심목록</span>
          </div>
        </div>
        <div className="mt-12">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-800">동동</h4>
